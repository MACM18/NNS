  ...
  const fetchLineStats = async () => {
    ...
    try {
      ...
      const stats = {
        ...
        completed: lines?.filter((l: any) => l.completed === true || l.status === "completed").length || 0,
        ...
        <main className="flex-1 space-y-6 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">{lineStats.completed}</div>
                <p className="text-xs text-muted-foreground">
                  {lineStats.total > 0 ? Math.round((lineStats.completed / lineStats.total) * 100) : 0}% completion rate
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-blue-600">{lineStats.inProgress}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-orange-600">{lineStats.pending}</div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed view of all telecom lines for {months.find((m) => m.value === selectedMonth)?.label}{" "}
                {selectedYear}
              </CardDescription>
            </CardHeader>
            <CardContent>
