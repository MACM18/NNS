    ...
    try {
      ...
      if (data) {
        setCompanyData({
          ...
          pricing_tiers: data.pricing_tiers || companyData.pricing_tiers,
          bank_details: data.bank_details || companyData.bank_details,
        })
      }
    } catch (error) {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setCompanyData({ ...companyData, registered_number: e.target.value })}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setNotificationSettings({ ...notificationSettings, task_reminders: checked })
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setNotificationSettings({ ...notificationSettings, invoice_alerts: checked })
                        }
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setSecuritySettings({ ...securitySettings, password_expiry: value })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
