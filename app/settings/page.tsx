...
export default function SettingsPage() {
  ...
  const [companyName, setCompanyName] = useState("NNS Telecom")
  const [companyAddress, setCompanyAddress] = useState("123 Telecom St, Fiber City, FC 12345")
  const [contactEmail, setContactEmail] = useState("info@nnstelecom.com")
    ...
    try {
      ...
      if (data) {
        setCompanyData({
          ...
          contact_numbers: Array.isArray(data.contact_numbers) ? (data.contact_numbers as string[]) : [""],
          website: typeof data.website === "string" ? data.website : "",
          registered_number: typeof data.registered_number === "string" ? data.registered_number : "",
          pricing_tiers: Array.isArray(data.pricing_tiers) ? data.pricing_tiers : companyData.pricing_tiers,
          bank_details:
            data.bank_details &&
  ...
  const handleSaveNotificationSettings = () => {
    ...
    console.log({ notificationsEnabled, emailNotifications, smsNotifications })
    toast({
  ...
  const handleSaveContactInfo = () => {
    // In a real app, you'd send this to your backend
    console.log({ companyName, companyAddress, contactEmail, contactPhone })
    toast({
      title: "Settings Saved",
            ...
            <TabsContent value="company" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure company details for invoices and documents</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure pricing based on cable length</CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={index} className="grid grid-cols-4 gap-4 items-end">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            value={tier.rate}
                            onChange={(e) =>
                              handlePricingTierChange(index, "rate", Number.parseInt(e.target.value) || 0)
                            }
                          />
                        </div>
                        <div className="text-sm text-muted-foreground">
                          {tier.min_length}–{tier.max_length === 999999 ? "500+" : tier.max_length}
                          m: LKR {tier.rate}
                        </div>
                      </div>
                    ))}
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure bank information for invoices</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
            ...
            <TabsContent value="data" className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Manage and cleanup your data</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Archive data older than 2 years</p>
                      </div>
                      <Button variant="outline" size="sm">
                        Archive Data
                      </Button>
