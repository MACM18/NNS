    ...
    <div className='container mx-auto px-4 py-12 max-w-4xl'>
      ...
      <div className='prose dark:prose-invert max-w-none space-y-6'>
        ...
        <p>
          ...
          carefully before using the NNS Enterprise application (the "Service")
          operated by NNS ("us", "we", or "our").
        </p>
        ...
        <p>
          ...
          your Google account as permitted by you and Google's terms of service.
        </p>
        <p>
          ...
          their data in your connected Google account to the extent necessary to
          provide the Service. We will only use this access to record and
        ...
        <p>
          ...
          and will remain the exclusive property of NNS and its licensors. The
        ...
        <p>
          ...
          that are not owned or controlled by NNS. We have no control over, and
        ...
        <p>
          In no event shall NNS, nor its directors, employees, partners, agents,
