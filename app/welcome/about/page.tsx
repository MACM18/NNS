          ...
          <div className='grid gap-12 lg:grid-cols-2 lg:gap-24'>
            <div className='space-y-6'>
              ...
              <p className='text-muted-foreground leading-relaxed'>
                ...
                laying the groundwork for seamless digital connectivity. We
                quickly established a reputation for reliability and excellence,
                becoming a trusted partner in the telecom industry.
              </p>
              <p className='text-muted-foreground leading-relaxed'>
                ...
                of technical services. This includes comprehensive repair and
            ...
            <div className='space-y-6'>
              ...
              <div className='grid gap-6 sm:grid-cols-2'>
                <Card>
                  ...
                  <CardContent>
                    <p className='text-sm text-muted-foreground'>
                      Continuously seeking new technologies and methods to
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className='text-sm text-muted-foreground'>
                      Working closely with partners and clients to achieve
                      shared success.
                    </p>
                  </CardContent>
                </Card>
