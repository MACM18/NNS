      ...
      <div className='container px-4 md:px-6'>
        <div className='max-w-3xl mx-auto text-center mb-12'>
          ...
          <p className='mt-4 text-lg text-muted-foreground'>
            ...
            advanced solutions, we cover all your telecom infrastructure needs.
          </p>
        </div>
        ...
        <div className='grid gap-12 lg:grid-cols-2 lg:gap-24'>
          <div className='space-y-8'>
            ...
            <p className='text-muted-foreground leading-relaxed'>
              ...
              (FTTH) infrastructure. We ensure high-speed, reliable connectivity
              is delivered with precision and adherence to the highest industry
              standards. Our process includes:
            </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className='text-sm text-muted-foreground'>
                    Detailed site surveys and network architecture planning for
                    optimal deployment.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className='space-y-8'>
            ...
            <p className='text-muted-foreground leading-relaxed'>
              Building on our foundation, we are actively expanding our service
              portfolio to provide end-to-end telecom solutions, ensuring your
              infrastructure remains cutting-edge and fully operational.
            </p>
            <div className='grid gap-6 sm:grid-cols-2'>
              <Card>
                <CardHeader className='flex flex-row items-center gap-4 pb-2'>
                ...
                <CardContent>
                  <p className='text-sm text-muted-foreground'>
                    Proactive and reactive services to ensure continuous optimal
