      ...
      <PublicLayout>
        <section className="py-12 md:py-24 lg:py-32 text-center">
          <div className="container px-4 md:px-6">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Article Not Found</h1>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="flex flex-wrap items-center gap-4 mt-2 text-muted-foreground">
                ...
                <span className="flex items-center gap-1">
                  <CalendarDays className="h-4 w-4" /> {format(new Date(post.created_at), "MMM dd, yyyy")}
                </span>
              </CardDescription>
            </CardHeader>
