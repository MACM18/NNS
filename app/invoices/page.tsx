        ...
        <main className='flex-1 space-y-6 p-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            ...
            <Card>
              ...
              <CardContent>
                <div className='text-2xl font-bold'>LKR 500K</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className='text-2xl font-bold'>LKR 10K</div>
                <p className='text-xs text-muted-foreground'>
                  Per installation
                </p>
              </CardContent>
            ...
            <TabsContent value='templates'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Customize invoice layout and branding
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='text-center py-8 text-muted-foreground'>
                    ...
                    <p>
                      Invoice template customization will be implemented here
                    </p>
                    <p className='text-sm'>
                      Features: Logo upload, custom headers, footer text
                    </p>
                  </div>
                </CardContent>
              </Card>
