...
export default function InvoicesPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const totalAmount = monthlyInvoices?.reduce((sum, inv) => sum + (inv.total_amount || 0), 0) || 0
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <main className="flex-1 space-y-6 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">LKR {stats.totalAmount.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">LKR {stats.avgRate.toLocaleString()}</div>
                ...
                <CardContent>
                  {loadingData ? (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm">Click "Generate Invoices" to create monthly invoices</p>
                    </div>
                  ) : (
                    <Table>
                      <TableHeader>
                      ...
                      <TableBody>
                        {invoices.map((invoice) => (
                          <TableRow key={invoice.id}>
                            ...
                            <TableCell>LKR {invoice.total_amount.toLocaleString()}</TableCell>
                            <TableCell>{getStatusBadge(invoice.status)}</TableCell>
                            <TableCell>
                              <div className="flex gap-2">
                                <Button size="sm" variant="outline" onClick={() => handlePreviewInvoice(invoice)}>
        ...
        <InvoicePDFModal open={pdfModalOpen} onOpenChange={setPdfModalOpen} invoice={selectedInvoice} />
      </SidebarInset>
    </SidebarProvider>
  )
}
