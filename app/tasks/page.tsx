...
import { Plus, Calendar, CheckCircle, XCircle, Clock, RefreshCw } from "lucide-react"
...
export default function TasksPage() {
  ...
  const handleAddSuccess = () => {
    fetchTasksForCurrentMonth() // Refresh data after adding task
  }
        ...
        <main className="flex-1 space-y-6 p-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={fetchTasksForCurrentMonth} disabled={isRefreshing}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{tasks.filter((task) => task.status === "accepted").length}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{tasks.filter((task) => task.status === "rejected").length}</div>
