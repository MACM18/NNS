 ...
 */
export function computeCableMeasurements(cableStart: number, cableMiddle: number, cableEnd: number) {
...
export const profiles = {
  ...
  findByEmail: (email: string) => prisma.profile.findFirst({ where: { email } }),
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  updateByUserId: (userId: string, data: any) => prisma.profile.update({ where: { userId }, data }),
...
export const users = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  create: (data: any) => prisma.user.create({ data, include: { profile: true } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.user.update({ where: { id }, data, include: { profile: true } }),
...
export const lineDetails = {
  ...
  findByTelephoneNo: (telephoneNo: string) => prisma.lineDetails.findFirst({ where: { telephoneNo } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findMany: (options?: any) => prisma.lineDetails.findMany(options),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  create: (data: any) => prisma.lineDetails.create({ data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.lineDetails.update({ where: { id }, data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export const tasks = {
  ...
  findByTelephoneNo: (telephoneNo: string) => 
    prisma.task.findFirst({ where: { telephoneNo }, orderBy: { createdAt: 'desc' } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export const inventoryItems = {
  ...
  findByName: (name: string) => prisma.inventoryItem.findUnique({ where: { name } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findMany: (options?: any) => prisma.inventoryItem.findMany(options),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  create: (data: any) => prisma.inventoryItem.create({ data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.inventoryItem.update({ where: { id }, data }),
...
export const drumTracking = {
  ...
  findByDrumNumber: (drumNumber: string) => prisma.drumTracking.findFirst({ where: { drumNumber } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findMany: (options?: any) => prisma.drumTracking.findMany(options),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  create: (data: any) => prisma.drumTracking.create({ data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.drumTracking.update({ where: { id }, data }),
...
export const drumUsage = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.drumUsage.update({ where: { id }, data }),
...
export const inventoryInvoices = {
  findById: (id: string) => prisma.inventoryInvoice.findUnique({ 
    where: { id },
    include: { items: true }
  }),
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.inventoryInvoice.update({ where: { id }, data }),
...
export const generatedInvoices = {
  findById: (id: string) => prisma.generatedInvoice.findUnique({ where: { id } }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  findMany: (options?: any) => prisma.generatedInvoice.findMany(options),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  create: (data: any) => prisma.generatedInvoice.create({ data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.generatedInvoice.update({ where: { id }, data }),
...
export const workers = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.worker.update({ where: { id }, data }),
...
export const workAssignments = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.workAssignment.update({ where: { id }, data }),
...
export const notifications = {
  ...
  markAsRead: (id: string) => prisma.notification.update({ where: { id }, data: { isRead: true } }),
...
export const googleSheetConnections = {
  findById: (id: string) => prisma.googleSheetConnection.findUnique({ where: { id } }),
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.googleSheetConnection.update({ where: { id }, data }),
  delete: (id: string) => prisma.googleSheetConnection.delete({ where: { id } }),
};
...
export const blogs = {
  ...
  findActive: () => prisma.blog.findMany({ 
    where: { status: 'active' },
    orderBy: { createdAt: 'desc' }
  }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: number, data: any) => prisma.blog.update({ where: { id }, data }),
...
export const posts = {
  ...
  findActive: () => prisma.post.findMany({ 
    where: { status: 'active' },
    orderBy: { createdAt: 'desc' }
  }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: number, data: any) => prisma.post.update({ where: { id }, data }),
...
export const jobVacancies = {
  ...
  findActive: () => prisma.jobVacancy.findMany({ 
    where: { status: 'active' },
    orderBy: { createdAt: 'desc' }
  }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: number, data: any) => prisma.jobVacancy.update({ where: { id }, data }),
...
export const companySettings = {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  update: (id: string, data: any) => prisma.companySettings.update({ where: { id }, data }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  upsert: (data: any) =>
