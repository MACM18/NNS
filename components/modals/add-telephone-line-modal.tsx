...
export function AddTelephoneLineModal({
  ...
  useEffect(() => {
    ...
    formData.cable_start_new,
    formData.cable_middle_new,
    formData.cable_end_new,
  ]);
  ...
  const handleInputChange = (field: string, value: string | number) => {
    ...
    if (field === "selected_drum_id" && value) {
      ...
      if (selectedDrum) {
        setFormData((prev) => ({
          ...prev,
          drum_number_new: selectedDrum.drum_number,
        }));
      }
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const insertData = {
        ...
        fiber_rosette_new:
          Number.parseInt(formData.fiber_rosette_new.toString()) || 1,
        ...
        concrete_nail_new:
          Number.parseInt(formData.concrete_nail_new.toString()) || 0,
        roll_plug_new: Number.parseInt(formData.roll_plug_new.toString()) || 0,
        screw_nail_new:
          Number.parseInt(formData.screw_nail_new.toString()) || 0,
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("power_dp_new", e.target.value)
                  }
                  className={
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("power_inbox_new", e.target.value)
                  }
                  className={
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("cable_start_new", e.target.value)
                  }
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("cable_middle_new", e.target.value)
                  }
                  required
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("cable_end_new", e.target.value)
                  }
                  required
                />
              </div>
          ...
          <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                ...
                <div>
                  ...
                  <p className='text-xs text-blue-600 mt-1'>
                    Auto: ½ of L-Hook (
                    {Math.ceil(
                      (Number.parseInt(formData.l_hook_new.toString()) || 0) / 2
                    )}
                    )
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className='text-xs text-blue-600 mt-1'>
                    Auto: Same as Roll Plug ({formData.roll_plug_new})
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <div>
                  <Label htmlFor='fiber_rosette_new'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("internal_wire_new", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("cat5_new", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("casing_new", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("conduit_new", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("voice_test_no_new", e.target.value)
                    }
